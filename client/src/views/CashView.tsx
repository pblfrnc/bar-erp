...
export const CashView: React.FC<CashViewProps> = ({ onRefreshStatus }) => {
  ...
  return (
    <div className="space-y-4 pb-20 max-w-6xl mx-auto">
        ...
        <div className="flex items-center gap-3.5">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h2 className="text-xl font-black text-white">Frente de Caixa (PDV)</h2>
              <span
            ...
            <p className="text-xs text-slate-400">
              Controle de suprimento, sangria, recebimentos e fechamento cego
            </p>
          </div>
        </div>
      ...
      {!shiftData.isOpen ? (
        <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 sm:p-8 max-w-lg mx-auto shadow-2xl">
          <div className="w-16 h-16 rounded-3xl bg-amber-500/20 border border-amber-500/30 flex items-center justify-center text-amber-400 mx-auto mb-4">
            <Unlock className="w-8 h-8" />
          </div>
          <h3 className="text-xl font-black text-white text-center">Abrir Turno de Caixa</h3>
          ...
          <form onSubmit={handleOpenShift} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-slate-950 border border-slate-800 rounded-xl text-white text-lg font-mono font-bold focus:border-amber-500 focus:outline-none"
              />
            </div>
            ...
            <div>
              ...
              <input
                type="text"
                placeholder="Ex: Turno Noturno de Sexta-feira"
                value={openNotes}
            ...
            <button
              type="submit"
              className="w-full py-3.5 px-4 rounded-xl font-black text-sm uppercase tracking-wide bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-400 text-slate-950 transition shadow-lg shadow-emerald-500/20 active:scale-95 mt-2"
            >
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-2xl p-4">
              ...
              <div className="text-xs font-mono font-bold mt-1 space-y-0.5">
                <span className="text-blue-400 block">+ R$ {(summary?.totalSupplies || 0).toFixed(2)}</span>
                <span className="text-red-400 block">- R$ {(summary?.totalWithdrawals || 0).toFixed(2)}</span>
              </div>
            </div>

            <div className="bg-slate-900 border border-amber-500/40 rounded-2xl p-4 bg-amber-950/10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-3xl p-5 flex flex-col justify-between space-y-3">
              <div>
                <h3 className="text-sm font-black uppercase tracking-wider text-slate-200 mb-1">
                  Ações de Caixa
                </h3>
                ...
                <div className="space-y-2">
                  <button
                    ...
                    className="w-full py-2.5 px-3 rounded-xl text-xs font-bold bg-red-600/20 text-red-300 hover:bg-red-600 hover:text-white border border-red-500/30 transition flex items-center justify-center gap-1.5 active:scale-95"
                  >
                  ...
                  <button
                    ...
                    className="w-full py-2.5 px-3 rounded-xl text-xs font-bold bg-blue-600/20 text-blue-300 hover:bg-blue-600 hover:text-white border border-blue-500/30 transition flex items-center justify-center gap-1.5 active:scale-95"
                  >
              ...
              <button
                ...
                className="w-full py-3 px-3 rounded-xl text-xs font-black uppercase tracking-wider bg-amber-500 hover:bg-amber-400 text-slate-950 transition flex items-center justify-center gap-2 shadow-lg shadow-amber-500/20 active:scale-95"
              >
            ...
            <div className="space-y-2 max-h-72 overflow-y-auto">
              {shift?.payments && shift.payments.length > 0 ? (
                shift.payments.map((p) => (
                  ...
                  >
                    <div className="flex items-center gap-2">
                      <span className="p-1.5 rounded-lg bg-emerald-500/10 text-emerald-400 font-bold text-[10px]">
                        PAGAMENTO
                      </span>
      ...
      {showCloseModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
          <div className="bg-slate-900 border border-slate-800 rounded-3xl w-full max-w-md p-6 shadow-2xl">
            <h3 className="text-xl font-black text-white mb-2">Fechamento Cego de Caixa</h3>
            <p className="text-xs text-slate-400 mb-4">
              Conte o dinheiro físico em espécie presente na gaveta e digite o total apurado.
            </p>
              ...
              <div className="space-y-4">
                <div className="p-4 rounded-2xl bg-slate-950 border border-slate-800 space-y-2 text-xs">
                  ...
                  <div className="flex justify-between pt-2 border-t border-slate-800 font-bold">
                    ...
                    <span
                      className={`font-mono ${
                        closeReport.difference >= 0 ? 'text-emerald-400' : 'text-red-400'
                      }`}
                    >
                ...
                <button
                  ...
                  className="w-full py-3 rounded-xl font-bold text-xs bg-emerald-500 text-slate-950"
                >
                  Concluir Fechamento
                </button>
              </div>
              ...
              <form onSubmit={handleCloseShift} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-slate-950 border border-slate-800 rounded-xl text-white font-mono text-xl font-bold focus:border-amber-500 focus:outline-none"
                    autoFocus
                  />
                </div>
                ...
                <div className="pt-2 flex gap-2">
                  ...
                  <button
                    type="submit"
                    className="flex-1 py-3 rounded-xl font-bold text-xs bg-red-600 hover:bg-red-500 text-white transition"
                  >
                    Encerrar Caixa
                  </button>
                </div>
